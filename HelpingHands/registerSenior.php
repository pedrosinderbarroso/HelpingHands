...
<body ng-controller="helpingHandsCtrl">
	...
	<form name="seniorForm">
        ...
        <select class="form-control" ng-model="senior.state" ng-options="state.abbreviation for state in states" ng-required="true">
            <option value="">Select a state</option>
        </select>
		<input class="form-control" type="text" ng-model="senior.zipcode" name="zipcode" placeholder="Zipcode" ng-required="true" ng-pattern="/^[0-9]{5}$/"/>
	...
	<div ng-show="seniorForm.zipcode.$error.required && seniorForm.zipcode.$dirty" class="alert alert-danger">
		Please fill out your zipcode
	</div>
	<div ng-show="seniorForm.zipcode.$error.pattern" class="alert alert-danger">
