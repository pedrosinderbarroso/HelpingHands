...
<body ng-controller="nurseCtrl">
    ...
    <form name="nurseForm">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input class="form-control" type="text" ng-model="nurse.license" name="license" placeholder="License Number" ng-required="true"/>
            </div>
            <div class="form-group col-md-6">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-2">
                ...
                <input class="form-control" type="text" ng-model="nurse.zipcode" name="zipcode" placeholder="Zipcode" ng-required="true" ng-minlength="5" ng-maxlength="5"/>
            </div>
        </div>
        <div class="form-row">
            <div class="form-group col-md-12">
                <label>In a few words describe your medical condition:</label>
                <textarea class="form-control" type="text" ng-model="nurse.condition" name="condition" placeholder="Description of Condition" ng-required="true"></textarea>
            </div>
        </div>
        <label>Emergency Contact Information: </label>
        <div class="form-row">
            <div class="form-group col-md-5">
                <input class="form-control" type="text" ng-model="nurse.emergencyname" name="emergencyname" placeholder="Name" ng-required="true"/>
            </div>
            <div class="form-group col-md-5">
                <input class="form-control" type="text" ng-model="nurse.emergencylast" name="emergencylast" placeholder="Lastname" ng-required="true"/>
            </div>
            <div class="form-group col-md-2">
                <input class="form-control" type="text" ng-model="nurse.emergencyphone" name="emergencyphone" placeholder="Phone Number" ng-required="true" ng-minlength="13" ui-phone/>
            </div>
        </div>  
    </form>
    ...
    <div ng-show="nurseForm.dob.$error.required && nurseForm.dob.$dirty" class="alert alert-danger">
        Please fill out your date of birth!
    </div>
    <div ng-show="nurseForm.dob.$error.minlength" class="alert alert-danger">
    ...
    <div ng-show="nurseForm.zipcode.$invalid && nurseForm.zipcode.$dirty" class="alert alert-danger">
        Please fill out your zipcode!
    </div>
    <div ng-show="nurseForm.zipcode.$error.minlength || nurseForm.zipcode.$error.maxlength" class="alert alert-danger">
    ...
    <div ng-show="nurseForm.condition.$invalid && nurseForm.condition.$dirty" class="alert alert-danger">
        Please fill out your(s) condition(s)!
    </div>
    <div ng-show="nurseForm.emergencyname.$invalid && nurseForm.emergency.$dirty" class="alert alert-danger">
        Please fill out your emergency contact name!
    </div>
    <div ng-show="nurseForm.emergencylast.$invalid && nurseForm.emergency.$dirty" class="alert alert-danger">
        Please fill out your emergency contact last name!
    </div>
    <div ng-show="nurseForm.emergencyphone.$invalid && nurseForm.emergency.$dirty" class="alert alert-danger">
        Please fill out your emergency contact phone number!
    </div>
    <div ng-show="nurseForm.emergencyphone.$error.minlength" class="alert alert-danger">
        Please enter a valid phone number.
    </div>
        <button class="btn btn-primary btn-block" ng-disabled="nurseForm.$invalid" ng-click="insertSenior()">Register</button>
                <div style="color: red">
                        {{msg}}
                </div>
    </div>
